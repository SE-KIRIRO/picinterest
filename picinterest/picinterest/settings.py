"""
Django settings for picinterest project.
...
ALLOWED_HOSTS = ['picinterest.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'picinterest.wsgi.application'
...
SOCIAL_AUTH_FACEBOOK_SCOPE = [os.environ.get("EMAIL_HOST_USER")]
